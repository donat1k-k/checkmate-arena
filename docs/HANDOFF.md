...
### Следующий логичный этап
- Stage 8.1B: decide whether local clan tag editing, cosmetic equip/apply
  surfaces, richer profile scouting, and a deeper store catalog should remain
  local or wait for entitlement/backend design.
