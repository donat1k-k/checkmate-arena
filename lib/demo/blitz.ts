...
export const BLITZ_PUZZLES: BlitzPuzzle[] = [
  ...
  },
  {
    ...
    titleRu: "Диагональный удар",
    fen: "6k1/6pp/8/8/8/8/6PP/5BK1 w - - 0 1",
    sideToMove: "w",
    solution: "Bh7",
    difficulty: "easy",
    timeLimitSeconds: 20,
    explanation: "Bishop to h7 is checkmate. The king on g8 has no escape — g7 pawn blocks it and white king covers f7.",
    explanationRu: "Слон на h7 — мат. Король на g8 не имеет выхода: пешка g7 блокирует, белый король контролирует f7.",
    rewardCoins: 5,
  },
  {
    id: "bp12",
  ...
  },
  {
    ...
    fen: "8/8/6k1/8/8/6K1/8/6R1 w - - 0 1",
    sideToMove: "w",
    solution: "Rg8",
    difficulty: "medium",
    timeLimitSeconds: 15,
    explanation: "Rook to g8 is checkmate. The king on g6 is in a corridor — white king covers h5, f5 and the rook seals the 8th rank.",
    explanationRu: "Ладья на g8 — мат. Король g6 в коридоре: белый король закрывает h5 и f5, ладья перекрывает восьмую горизонталь.",
    rewardCoins: 8,
  },
  {
    id: "bp14",
  ...
  },
  {
    ...
    fen: "3rk3/3p1ppp/8/8/8/3R4/8/3R2K1 w - - 0 1",
    sideToMove: "w",
    solution: "Rd8",
    difficulty: "hard",
    timeLimitSeconds: 10,
    explanation: "Rook to d8 forces checkmate. Taking with the rook allows Rxd8#, and the king has nowhere to run.",
    explanationRu: "Ладья на d8 — форсированный мат. Взятие допускает Rxd8#, а королю некуда бежать.",
    rewardCoins: 12,
  },
  {
    id: "bp18",
