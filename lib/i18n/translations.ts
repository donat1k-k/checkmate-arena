...
export const translations = {
  en: {
    ...
    economy: {
      ...
      internalOnly: "Demo internal currency only. No cash value.",
      matchReward: (amount: number) => `+${amount} AC earned`,
      homeSignal: "Play matches to grow a demo Arena Coins balance.",
    },
    home: {
    ...
    pro: {
      ...
      boundary:
        "Stage 8 keeps monetization visual only: no checkout, payments, or premium entitlements are wired.",
      ...
      storeTitle: "Spend AC on identity later",
      storeBody:
        "Store items are teasers only. Arena Coins remain an internal demo currency.",
      storeItems: [
  ...
  ru: {
    ...
    economy: {
      ...
      internalOnly: "Только внутренняя demo-валюта без денежной ценности.",
      matchReward: (amount: number) => `Заработано +${amount} AC`,
      homeSignal: "Играйте матчи, чтобы растить demo-баланс Arena Coins.",
    },
    home: {
    ...
    pro: {
      ...
      boundary:
        "Stage 8 оставляет монетизацию визуальной: checkout, платежи и премиальные права не подключены.",
      label: "Checkmate Arena Pro",
      comingSoon: "Скоро",
      ...
      storeEyebrow: "Arena Store",
      storeTitle: "Позже AC превратятся в статус",
      storeBody:
        "Предметы магазина пока превью. Arena Coins остаются внутренней demo-валютой.",
      storeItems: [
