...
export const translations = {
  en: {
    ...
    pro: {
      ...
      comparisonRows: [
        { feature: "Post-game review", free: "Basic", pro: "Unlimited", ultra: "Priority" },
        { feature: "Training loop", free: "Preview", pro: "Mistake drills", ultra: "Deep coach" },
        { feature: "Customization", free: "Default", pro: "Board themes", ultra: "Premium skins" },
        { feature: "Social layer", free: "Global ladder", pro: "City preview", ultra: "Clan labs" },
        { feature: "Rooms", free: "Local", pro: "Friend preview", ultra: "Tournament labs" },
      ],
  ...
  ru: {
    ...
    pro: {
      ...
      comparisonRows: [
        { feature: "Разбор после партии", free: "Базовый", pro: "Безлимит", ultra: "Приоритет" },
        { feature: "Тренировочная петля", free: "Превью", pro: "Дриллы ошибок", ultra: "Глубокий coach" },
        { feature: "Кастомизация", free: "По умолчанию", pro: "Темы доски", ultra: "Премиум-скины" },
        { feature: "Social-слой", free: "Глобальный ладдер", pro: "Превью города", ultra: "Клановые эксперименты" },
        { feature: "Комнаты", free: "Локально", pro: "Превью друзей", ultra: "Турнирные эксперименты" },
      ],
      storeEyebrow: "Arena Store",
